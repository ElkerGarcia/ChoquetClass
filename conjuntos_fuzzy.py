# -*- coding: utf-8 -*-
"""conjuntos_fuzzy.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1TS-yMdvT_1jW2cHjRFp_5Ffj16wPIe59
"""
...
#########################################
# FUNCIONES DE MEMBRESÍA LISTAS PARA SU USO#
#########################################
...
class Triangular_MF(MF_object):
    """
        crea una función de membresía triangular normalizada.
        requiere que a <= b <= c y la semántica es la siguiente:
        ::
    ...
    Argumentos:
a: coordenada del universo del discurso del vértice más a la izquierda.
b: coordenada del universo del discurso del vértice superior.
c: coordenada del universo del discurso del vértice más a la derecha..
    """
    ...
    def __init__(self, a=0, b=0.5, c=1):
        ...
        self._c = c
        if (a>b):
            raise Exception("Error en el conjunto difuso triangular: a=%.2f debe ser <= b=%.2f" % (a,b))
        elif (b>c):
            raise Exception("Error en el conjunto difuso triangular: b=%.2f debe ser <= c=%.2f" % (b,c))
